...
from agx_emulsion.process.physics.color_filters import (
...
def black_body_spectrum(temperature):
    values = colour.colorimetry.blackbody.planck_law(
        SPECTRAL_SHAPE.wavelengths * 1e-9, temperature
    )  # to emulate an halogen lamp
