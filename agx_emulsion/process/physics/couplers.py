...
# from agx_emulsion.process.physics.diffusion import apply_gaussian_blurfilter import fast_gaussian_filter
...
def compute_exposure_correction_dir_couplers(
    ...
    if diffusion_size_pixel > 0:
        log_raw_correction = gaussian_filter(
            log_raw_correction, (diffusion_size_pixel, diffusion_size_pixel, 0)
        )
